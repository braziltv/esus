...
import { HelpCircle, UserPlus, Activity, Stethoscope, Heart, Bandage, Scan, BedDouble, Volume2, VolumeX, CheckCircle, ArrowRight, RefreshCw, AlertTriangle } from 'lucide-react';
...
export function QuickHelpPanel({ variant = 'icon', className = '' }: QuickHelpPanelProps) {
